...
namespace SiteExpensesManagement.App.DataAccess.EntityFramework.Migrations
{
    ...
    [Migration("20220412175833_Messages Table added")]
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Apartment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 12, 20, 58, 33, 670, DateTimeKind.Local).AddTicks(5921));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 12, 20, 58, 33, 672, DateTimeKind.Local).AddTicks(1856));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Car", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 12, 20, 58, 33, 673, DateTimeKind.Local).AddTicks(2473));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Dues", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 12, 20, 58, 33, 674, DateTimeKind.Local).AddTicks(6921));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 12, 20, 58, 33, 676, DateTimeKind.Local).AddTicks(3981));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.RoomType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 12, 20, 58, 33, 675, DateTimeKind.Local).AddTicks(3475));
