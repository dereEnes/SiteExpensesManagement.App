...
namespace SiteExpensesManagement.App.DataAccess.EntityFramework.Migrations
{
    ...
    [Migration("20220412141320_TcNo column updated to Identity Number")]
    partial class TcNocolumnupdatedtoIdentityNumber
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Apartment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 12, 17, 13, 20, 548, DateTimeKind.Local).AddTicks(4712));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 12, 17, 13, 20, 550, DateTimeKind.Local).AddTicks(951));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Car", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 12, 17, 13, 20, 551, DateTimeKind.Local).AddTicks(1263));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Dues", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 12, 17, 13, 20, 552, DateTimeKind.Local).AddTicks(2854));

                    b.Property<DateTime>("DuesDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Rooms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 12, 17, 13, 20, 552, DateTimeKind.Local).AddTicks(9639));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Apartment", b =>
                {
                    b.HasOne("SiteExpensesManagement.App.Domain.Entities.Rooms", "RoomType")
                        .WithMany("Apartments")
