...
namespace SiteExpensesManagement.App.DataAccess.EntityFramework.Migrations
{
    ...
    [Migration("20220411163318_CreateDomains")]
    partial class CreateDomains
    {
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Apartment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 11, 19, 33, 18, 581, DateTimeKind.Local).AddTicks(6392));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 11, 19, 33, 18, 583, DateTimeKind.Local).AddTicks(1384));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Car", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 11, 19, 33, 18, 583, DateTimeKind.Local).AddTicks(9127));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Dues", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 11, 19, 33, 18, 584, DateTimeKind.Local).AddTicks(9806));
            ...
            modelBuilder.Entity("SiteExpensesManagement.App.Domain.Entities.Rooms", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 11, 19, 33, 18, 585, DateTimeKind.Local).AddTicks(5778));
